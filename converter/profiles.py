...
PROFILES: Dict[str, Profile] = {
    "angebot": Profile(
        ...
        default_template="local/templates/angebot.docx",
    ...
    "bericht": Profile(
        ...
        default_template="local/templates/bericht.docx",
    ...
    "analyse": Profile(
        ...
        default_template="local/templates/analyse.docx",
    ...
    "script": Profile(
        ...
        default_template="local/templates/script.docx",
